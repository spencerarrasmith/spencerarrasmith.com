...
-------
## Programs
* EW Phased Array (X-Band)
* [Next Gen Phased Antenna Arrays (Ku/Ka Band)](https://www.ses.com/insights/blog/ball-aerospaces-groundbreaking-esa-technology-brings-multiorbit-capabilities)
* [MEO Missile Tracking Satellite Payload (SWIR)](https://www.baesystems.com/en/article/bae-systems-awarded-contract-for-us-space-force-missile-warning-and-tracking-satellite-system)
* [Airlink Airborne Antenna (L-Band)](https://www.linkedin.com/posts/smdsymposium-missiledefense-spaceindustry-share-7095102698189950976-KckU/)

-------
## Leadership
* Software Developer Environment Working Group Lead
* [Blender 101 Class](/project.html?id=blender-class)
* Scrum Lead

-------
## Miscellaneous
* Tested and debugged circuit boards with electrical engineers
